...
![Addon Products - How to setup with real use case](../.gitbook/assets/addon-products-example.png)
...
At first, you need to add the checkbox option type to your option set. Then you need to add the product’s name and the price for each product. If you want you can add the image too. Like below:

![Addon Products - Step 1](../.gitbook/assets/addon-products-step-1.png)
...
![Addon Products - Step 2](../.gitbook/assets/addon-products-step-2.png)
