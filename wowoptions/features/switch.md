...
![Switch — How to setup with real use case](images/05-switch-example.png)

### Step 1

First, add the option type Switch to your options set. Click on the option type ”Switch”.

![Switch — Step 1](images/05-switch-step-1.png)
