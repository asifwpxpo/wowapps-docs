...
<figure><img src="../.gitbook/assets/add-option-value-description-example.png" alt=""><figcaption></figcaption></figure>
...
![Add Option Value Description - Step 1](../.gitbook/assets/add-option-value-description-step-1.png)

### Step 2

Below the option field, you will see 3 buttons and one of them is **Add Option Descriptions**. Click on that.

![Add Option Value Description - Step 2](../.gitbook/assets/add-option-value-description-step-2.png)
...
![Add Option Value Description - Step 3](../.gitbook/assets/add-option-value-description-step-3.png)

At last, do not forget to add this option set to your products and save it to check the final result.

![Add Option Value Description - Step 3 (2)](../.gitbook/assets/add-option-value-description-step-3-2.png)
