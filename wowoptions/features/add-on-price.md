...
You will see that the additional price is automatically added to the product price. For example, selecting the 16" × 20" poster size adds an extra $20.00 to the product price, as shown in the screenshot below. See the attached screenshot below.

![Add-on Price - Step 3](../.gitbook/assets/add-on-price-step-3.png)
