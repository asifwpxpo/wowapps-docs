...
<table>
  ...
  <tbody>
    <tr>
      <td>Show</td>
      <td>Any</td>
      <td>The field appears if any rule matches.</td>
    </tr>
    <tr>
      <td>Show</td>
      <td>All</td>
      <td>The field appears only if all rules match.</td>
    </tr>
    <tr>
      <td>Hide</td>
      <td>Any</td>
      <td>The field is hidden if any rule matches.</td>
    </tr>
    <tr>
      <td>Hide</td>
      <td>All</td>
      <td>The field is hidden only if all rules match.</td>
    </tr>
  </tbody>
</table>
