...
The internal name used to identify the divider in the options editor. This label is not shown to customers on the product page.

Example: Divider

### Height

Controls the vertical thickness of the divider line displayed between option fields. Use the slider to adjust how visually prominent the divider appears when separating sections.
...
Use this tab to control the visibility of the Divider option. You can show or hide it only when specific custom options or Shopify variants are selected. To learn how to configure conditional logic, follow this guide.
