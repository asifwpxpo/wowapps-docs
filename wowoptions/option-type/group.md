...
![Select Group Option](../.gitbook/assets/wowoptions-select-group-option.webp)

Here’s an example of how the Group appears on the frontend

![Group Option Example](../.gitbook/assets/wowoptions-group-option-example.webp)
...
![General Settings for Group Option](../.gitbook/assets/wowoptions-general-settings-for-group-option.webp)
...
![Group Option Style Tab](../.gitbook/assets/wowoptions-group-option-style-tab.webp)
...
If you experience any issues while configuring Group options, reach out to the WowApps support team via the in-app chat or email [**support@wowapps.io**](mailto:support@wowapps.io). You can also contact the dedicated manager at [**nayeem@wowapps.io**](mailto:nayeem@wowapps.io).
